...
- **❓ Задать вопрос** - отправить вопрос собеседующему *(запланировано)*
- **❌ Отменить запись** - отменить запись (можно 1 раз) *(запланировано)*

### Для собеседующих:
- **Ответить на вопрос** - ответить кандидату *(запланировано)*
...
- `/my_interviews` - свои записи *(запланировано)*
...
1. `/my_interviews` - просмотр записей для собеседующего
2. Обработчик отмены записи кандидатом (кнопка есть)
3. Обработчик вопросов/ответов (кнопка есть)
4. `/view_all_interviews` - просмотр всех записей (админ)
